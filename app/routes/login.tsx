...
function RouteComponent() {
  ...
  return (
    <Grid className="bg-bg-soft-200 relative h-screen w-screen p-2">
      <Image
        path="auth.webp"
        width={1920}
        height={1080}
      ...
      />
      <div className="bg-bg-white-0 shadow-regular-xs relative z-10 col-span-5 flex h-full flex-col items-center justify-center gap-5 rounded-3xl p-6 *:max-w-screen-sm">
        ...
        >
          ...
          <div className="text-paragraph-sm text-text-sub-600 flex items-baseline justify-center gap-1">
