...
function RouteComponent() {
  ...
  return (
    <>
      {/* <div className="sticky top-14 z-10 mt-2 flex w-screen items-start gap-8 px-8"> */}
      ...
      <div className="mx-auto flex w-full max-w-screen-lg flex-col gap-6">
        {Array.from({ length: 10 }).map((_, i) => (
          <div key={i} className="aspect-square w-1/2 bg-red-100">
            {i}
          </div>
        ))}
      </div>
    ...
    // <Grid
    //   gap="xs"
    //   className="mx-auto h-[calc(100dvh-92px)] max-h-[calc(100dvh-92px)] max-w-screen-2xl overflow-hidden"
    // >
    //   <div className="col-span-3 bg-blue-100">1</div>
    //   <div className="col-span-6 flex h-[calc(100dvh-92px)] flex-col gap-6 overflow-x-hidden overflow-y-scroll bg-blue-100">
    //     {Array.from({ length: 10 }).map((_, i) => (
    //       <div key={i} className="aspect-square w-1/2 bg-red-100">
    //         {i}
    //       </div>
