    ...
    return (
      ...
      >
        ...
        >
          ...
          <div className="shadow-md grid grid-cols-1 rounded-[14px] bg-bg-weak-50 p-1 drop-shadow-xl">
            <div className="rounded-10 bg-bg-white-0 ring-1 ring-stroke-soft-200 drop-shadow-xl">
